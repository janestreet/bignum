(* OASIS_START *)
(* DO NOT EDIT (digest: 75852ce53eba309cc31e7792e122f176) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/$NAME";
          synopsis =
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\187\002H\225>\137\248\139\159\203\132\023jy\205h";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
